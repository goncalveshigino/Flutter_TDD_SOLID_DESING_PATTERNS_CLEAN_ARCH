...
void main() {
  ...
  testWidgets('should handle loading correctly', (WidgetTester tester) async {
   ...
   testWidgets('should presenter error if loadSurveysStream fails', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('should presenter list if loadSurveysStream succeeds', (WidgetTester tester) async {
    await loadPage(tester);
