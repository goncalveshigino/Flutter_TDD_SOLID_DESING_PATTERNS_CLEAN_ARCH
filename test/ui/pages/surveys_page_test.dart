...
void main() {
  ...
  testWidgets('should handle loading correctly', (WidgetTester tester) async {
   ...
   testWidgets('should presenter error if surveysStream fails', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('should presenter list if surveysStream succeeds', (WidgetTester tester) async {
    await loadPage(tester);
